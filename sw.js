const cacheName = 'site-static-v23-22' // need to update version with changes
const dynamicCacheName = 'site-dynamic-v6-10' // need to update version with changes
const assets = [
  '/',
  '/index.html',
  '/js/app.js',
...
self.addEventListener('activate', (event) => {
  ...
  // waitUntil() extends the life of the event so it doesn't terminate before the cache is found
  event.waitUntil(
